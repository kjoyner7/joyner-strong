 ...
 * @see com.tmd.dao.data.VtigerInventoryTandc
 * @author Hibernate Tools
 */
public class VtigerInventoryTandcHome {

	private static final Log log = LogFactory.getLog(VtigerInventoryTandcHome.class);
	...
	public VtigerInventoryTandc merge(VtigerInventoryTandc detachedInstance) {
		...
		try {
			VtigerInventoryTandc result = (VtigerInventoryTandc) sessionFactory.getCurrentSession()
	...
	public VtigerInventoryTandc findById(int id) {
		...
		try {
			VtigerInventoryTandc instance = (VtigerInventoryTandc) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInventoryTandc", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInventoryTandc instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerInventoryTandc")
