 ...
 * @see com.tmd.dao.data.VtigerInventoryshippingrel
 * @author Hibernate Tools
 */
public class VtigerInventoryshippingrelHome {

	private static final Log log = LogFactory.getLog(VtigerInventoryshippingrelHome.class);
	...
	public VtigerInventoryshippingrel merge(VtigerInventoryshippingrel detachedInstance) {
		log.debug("merging VtigerInventoryshippingrel instance");
		try {
			VtigerInventoryshippingrel result = (VtigerInventoryshippingrel) sessionFactory.getCurrentSession()
	...
	public VtigerInventoryshippingrel findById(com.tmd.dao.data.VtigerInventoryshippingrelId id) {
		log.debug("getting VtigerInventoryshippingrel instance with id: " + id);
		try {
			VtigerInventoryshippingrel instance = (VtigerInventoryshippingrel) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInventoryshippingrel", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInventoryshippingrel instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerInventoryshippingrel").add(Example.create(instance)).list();
