 ...
 * @see com.tmd.dao.data.VtigerInventorysubproductrel
 * @author Hibernate Tools
 */
public class VtigerInventorysubproductrelHome {

	private static final Log log = LogFactory.getLog(VtigerInventorysubproductrelHome.class);
	...
	public VtigerInventorysubproductrel merge(VtigerInventorysubproductrel detachedInstance) {
		log.debug("merging VtigerInventorysubproductrel instance");
		try {
			VtigerInventorysubproductrel result = (VtigerInventorysubproductrel) sessionFactory.getCurrentSession()
	...
	public VtigerInventorysubproductrel findById(com.tmd.dao.data.VtigerInventorysubproductrelId id) {
		log.debug("getting VtigerInventorysubproductrel instance with id: " + id);
		try {
			VtigerInventorysubproductrel instance = (VtigerInventorysubproductrel) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInventorysubproductrel", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInventorysubproductrel instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerInventorysubproductrel").add(Example.create(instance))
					.list();
