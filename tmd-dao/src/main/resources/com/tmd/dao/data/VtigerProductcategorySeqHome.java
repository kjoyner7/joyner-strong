 ...
 * @see com.tmd.dao.data.VtigerProductcategorySeq
 * @author Hibernate Tools
 */
public class VtigerProductcategorySeqHome {

	private static final Log log = LogFactory.getLog(VtigerProductcategorySeqHome.class);
	...
	public VtigerProductcategorySeq merge(VtigerProductcategorySeq detachedInstance) {
		log.debug("merging VtigerProductcategorySeq instance");
		try {
			VtigerProductcategorySeq result = (VtigerProductcategorySeq) sessionFactory.getCurrentSession()
	...
	public VtigerProductcategorySeq findById(int id) {
		...
		try {
			VtigerProductcategorySeq instance = (VtigerProductcategorySeq) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerProductcategorySeq", id);
			if (instance == null) {
	...
	public List findByExample(VtigerProductcategorySeq instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerProductcategorySeq").add(Example.create(instance)).list();
