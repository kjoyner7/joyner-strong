 ...
 * @see com.tmd.dao.data.VtigerProducttaxrel
 * @author Hibernate Tools
 */
public class VtigerProducttaxrelHome {

	private static final Log log = LogFactory.getLog(VtigerProducttaxrelHome.class);
	...
	public VtigerProducttaxrel merge(VtigerProducttaxrel detachedInstance) {
		...
		try {
			VtigerProducttaxrel result = (VtigerProducttaxrel) sessionFactory.getCurrentSession()
	...
	public VtigerProducttaxrel findById(com.tmd.dao.data.VtigerProducttaxrelId id) {
		log.debug("getting VtigerProducttaxrel instance with id: " + id);
		try {
			VtigerProducttaxrel instance = (VtigerProducttaxrel) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerProducttaxrel", id);
			if (instance == null) {
	...
	public List findByExample(VtigerProducttaxrel instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerProducttaxrel")
