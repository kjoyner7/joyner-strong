 ...
 * @see com.tmd.dao.data.VtigerInventorytaxinfoSeq
 * @author Hibernate Tools
 */
public class VtigerInventorytaxinfoSeqHome {

	private static final Log log = LogFactory.getLog(VtigerInventorytaxinfoSeqHome.class);
	...
	public VtigerInventorytaxinfoSeq merge(VtigerInventorytaxinfoSeq detachedInstance) {
		log.debug("merging VtigerInventorytaxinfoSeq instance");
		try {
			VtigerInventorytaxinfoSeq result = (VtigerInventorytaxinfoSeq) sessionFactory.getCurrentSession()
	...
	public VtigerInventorytaxinfoSeq findById(int id) {
		...
		try {
			VtigerInventorytaxinfoSeq instance = (VtigerInventorytaxinfoSeq) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInventorytaxinfoSeq", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInventorytaxinfoSeq instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerInventorytaxinfoSeq").add(Example.create(instance)).list();
