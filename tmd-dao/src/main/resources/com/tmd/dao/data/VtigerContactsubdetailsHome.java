 ...
 * @see com.tmd.dao.data.VtigerContactsubdetails
 * @author Hibernate Tools
 */
public class VtigerContactsubdetailsHome {

	private static final Log log = LogFactory.getLog(VtigerContactsubdetailsHome.class);
	...
	public VtigerContactsubdetails merge(VtigerContactsubdetails detachedInstance) {
		log.debug("merging VtigerContactsubdetails instance");
		try {
			VtigerContactsubdetails result = (VtigerContactsubdetails) sessionFactory.getCurrentSession()
	...
	public VtigerContactsubdetails findById(int id) {
		...
		try {
			VtigerContactsubdetails instance = (VtigerContactsubdetails) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerContactsubdetails", id);
			if (instance == null) {
	...
	public List findByExample(VtigerContactsubdetails instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerContactsubdetails")
