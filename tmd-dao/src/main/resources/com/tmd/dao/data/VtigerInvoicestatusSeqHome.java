 ...
 * @see com.tmd.dao.data.VtigerInvoicestatusSeq
 * @author Hibernate Tools
 */
public class VtigerInvoicestatusSeqHome {

	private static final Log log = LogFactory.getLog(VtigerInvoicestatusSeqHome.class);
	...
	public VtigerInvoicestatusSeq merge(VtigerInvoicestatusSeq detachedInstance) {
		...
		try {
			VtigerInvoicestatusSeq result = (VtigerInvoicestatusSeq) sessionFactory.getCurrentSession()
	...
	public VtigerInvoicestatusSeq findById(int id) {
		...
		try {
			VtigerInvoicestatusSeq instance = (VtigerInvoicestatusSeq) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInvoicestatusSeq", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInvoicestatusSeq instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerInvoicestatusSeq")
