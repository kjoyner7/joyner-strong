 ...
 * @see com.tmd.dao.data.VtigerCustomerportalPrefs
 * @author Hibernate Tools
 */
public class VtigerCustomerportalPrefsHome {

	private static final Log log = LogFactory.getLog(VtigerCustomerportalPrefsHome.class);
	...
	public VtigerCustomerportalPrefs merge(VtigerCustomerportalPrefs detachedInstance) {
		log.debug("merging VtigerCustomerportalPrefs instance");
		try {
			VtigerCustomerportalPrefs result = (VtigerCustomerportalPrefs) sessionFactory.getCurrentSession()
	...
	public VtigerCustomerportalPrefs findById(com.tmd.dao.data.VtigerCustomerportalPrefsId id) {
		log.debug("getting VtigerCustomerportalPrefs instance with id: " + id);
		try {
			VtigerCustomerportalPrefs instance = (VtigerCustomerportalPrefs) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerCustomerportalPrefs", id);
			if (instance == null) {
	...
	public List findByExample(VtigerCustomerportalPrefs instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerCustomerportalPrefs").add(Example.create(instance)).list();
