 ...
 * @see com.tmd.dao.data.VtigerContactscf
 * @author Hibernate Tools
 */
public class VtigerContactscfHome {

	private static final Log log = LogFactory.getLog(VtigerContactscfHome.class);
	...
	public VtigerContactscf merge(VtigerContactscf detachedInstance) {
		...
		try {
			VtigerContactscf result = (VtigerContactscf) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public VtigerContactscf findById(int id) {
		...
		try {
			VtigerContactscf instance = (VtigerContactscf) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerContactscf", id);
			if (instance == null) {
	...
	public List findByExample(VtigerContactscf instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerContactscf")
