 ...
 * @see com.tmd.dao.data.VtigerInventorynotificationSeq
 * @author Hibernate Tools
 */
public class VtigerInventorynotificationSeqHome {

	private static final Log log = LogFactory.getLog(VtigerInventorynotificationSeqHome.class);
	...
	public VtigerInventorynotificationSeq merge(VtigerInventorynotificationSeq detachedInstance) {
		log.debug("merging VtigerInventorynotificationSeq instance");
		try {
			VtigerInventorynotificationSeq result = (VtigerInventorynotificationSeq) sessionFactory.getCurrentSession()
	...
	public VtigerInventorynotificationSeq findById(int id) {
		log.debug("getting VtigerInventorynotificationSeq instance with id: " + id);
		try {
			VtigerInventorynotificationSeq instance = (VtigerInventorynotificationSeq) sessionFactory
					.getCurrentSession().get("com.tmd.dao.data.VtigerInventorynotificationSeq", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInventorynotificationSeq instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerInventorynotificationSeq").add(Example.create(instance))
					.list();
