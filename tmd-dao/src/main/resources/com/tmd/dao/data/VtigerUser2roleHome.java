 ...
 * @see com.tmd.dao.data.VtigerUser2role
...
public class VtigerUser2roleHome {
	...
	public VtigerUser2role merge(VtigerUser2role detachedInstance) {
		...
		try {
			VtigerUser2role result = (VtigerUser2role) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public VtigerUser2role findById(int id) {
		...
		try {
			VtigerUser2role instance = (VtigerUser2role) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerUser2role", id);
			if (instance == null) {
	...
	public List findByExample(VtigerUser2role instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerUser2role")
