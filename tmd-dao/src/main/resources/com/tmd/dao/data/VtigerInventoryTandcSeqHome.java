 ...
 * @see com.tmd.dao.data.VtigerInventoryTandcSeq
 * @author Hibernate Tools
 */
public class VtigerInventoryTandcSeqHome {

	private static final Log log = LogFactory.getLog(VtigerInventoryTandcSeqHome.class);
	...
	public VtigerInventoryTandcSeq merge(VtigerInventoryTandcSeq detachedInstance) {
		log.debug("merging VtigerInventoryTandcSeq instance");
		try {
			VtigerInventoryTandcSeq result = (VtigerInventoryTandcSeq) sessionFactory.getCurrentSession()
	...
	public VtigerInventoryTandcSeq findById(int id) {
		...
		try {
			VtigerInventoryTandcSeq instance = (VtigerInventoryTandcSeq) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInventoryTandcSeq", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInventoryTandcSeq instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerInventoryTandcSeq")
