 ...
 * @see com.tmd.dao.data.VtigerProductcategory
 * @author Hibernate Tools
 */
public class VtigerProductcategoryHome {

	private static final Log log = LogFactory.getLog(VtigerProductcategoryHome.class);
	...
	public VtigerProductcategory merge(VtigerProductcategory detachedInstance) {
		...
		try {
			VtigerProductcategory result = (VtigerProductcategory) sessionFactory.getCurrentSession()
	...
	public VtigerProductcategory findById(java.lang.Integer id) {
		log.debug("getting VtigerProductcategory instance with id: " + id);
		try {
			VtigerProductcategory instance = (VtigerProductcategory) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerProductcategory", id);
			if (instance == null) {
	...
	public List findByExample(VtigerProductcategory instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerProductcategory")
