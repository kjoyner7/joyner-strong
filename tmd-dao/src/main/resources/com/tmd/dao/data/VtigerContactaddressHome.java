 ...
 * @see com.tmd.dao.data.VtigerContactaddress
 * @author Hibernate Tools
 */
public class VtigerContactaddressHome {

	private static final Log log = LogFactory.getLog(VtigerContactaddressHome.class);
	...
	public VtigerContactaddress merge(VtigerContactaddress detachedInstance) {
		...
		try {
			VtigerContactaddress result = (VtigerContactaddress) sessionFactory.getCurrentSession()
	...
	public VtigerContactaddress findById(int id) {
		...
		try {
			VtigerContactaddress instance = (VtigerContactaddress) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerContactaddress", id);
			if (instance == null) {
	...
	public List findByExample(VtigerContactaddress instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerContactaddress")
