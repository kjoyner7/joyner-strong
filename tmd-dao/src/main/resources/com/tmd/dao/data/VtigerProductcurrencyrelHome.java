 ...
 * @see com.tmd.dao.data.VtigerProductcurrencyrel
 * @author Hibernate Tools
 */
public class VtigerProductcurrencyrelHome {

	private static final Log log = LogFactory.getLog(VtigerProductcurrencyrelHome.class);
	...
	public VtigerProductcurrencyrel merge(VtigerProductcurrencyrel detachedInstance) {
		log.debug("merging VtigerProductcurrencyrel instance");
		try {
			VtigerProductcurrencyrel result = (VtigerProductcurrencyrel) sessionFactory.getCurrentSession()
	...
	public VtigerProductcurrencyrel findById(com.tmd.dao.data.VtigerProductcurrencyrelId id) {
		log.debug("getting VtigerProductcurrencyrel instance with id: " + id);
		try {
			VtigerProductcurrencyrel instance = (VtigerProductcurrencyrel) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerProductcurrencyrel", id);
			if (instance == null) {
	...
	public List findByExample(VtigerProductcurrencyrel instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerProductcurrencyrel").add(Example.create(instance)).list();
