 ...
 * @see com.tmd.dao.data.VtigerInvoiceRecurringInfo
 * @author Hibernate Tools
 */
public class VtigerInvoiceRecurringInfoHome {

	private static final Log log = LogFactory.getLog(VtigerInvoiceRecurringInfoHome.class);
	...
	public VtigerInvoiceRecurringInfo merge(VtigerInvoiceRecurringInfo detachedInstance) {
		log.debug("merging VtigerInvoiceRecurringInfo instance");
		try {
			VtigerInvoiceRecurringInfo result = (VtigerInvoiceRecurringInfo) sessionFactory.getCurrentSession()
	...
	public VtigerInvoiceRecurringInfo findById(int id) {
		log.debug("getting VtigerInvoiceRecurringInfo instance with id: " + id);
		try {
			VtigerInvoiceRecurringInfo instance = (VtigerInvoiceRecurringInfo) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInvoiceRecurringInfo", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInvoiceRecurringInfo instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerInvoiceRecurringInfo").add(Example.create(instance)).list();
