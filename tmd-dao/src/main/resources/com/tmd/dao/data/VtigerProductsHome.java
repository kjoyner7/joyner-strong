 ...
 * @see com.tmd.dao.data.VtigerProducts
...
public class VtigerProductsHome {
	...
	public VtigerProducts merge(VtigerProducts detachedInstance) {
		...
		try {
			VtigerProducts result = (VtigerProducts) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public VtigerProducts findById(int id) {
		...
		try {
			VtigerProducts instance = (VtigerProducts) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerProducts", id);
			if (instance == null) {
	...
	public List findByExample(VtigerProducts instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerProducts")
