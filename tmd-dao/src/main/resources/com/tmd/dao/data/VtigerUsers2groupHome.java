 ...
 * @see com.tmd.dao.data.VtigerUsers2group
 * @author Hibernate Tools
 */
public class VtigerUsers2groupHome {

	private static final Log log = LogFactory.getLog(VtigerUsers2groupHome.class);
	...
	public VtigerUsers2group merge(VtigerUsers2group detachedInstance) {
		...
		try {
			VtigerUsers2group result = (VtigerUsers2group) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public VtigerUsers2group findById(com.tmd.dao.data.VtigerUsers2groupId id) {
		log.debug("getting VtigerUsers2group instance with id: " + id);
		try {
			VtigerUsers2group instance = (VtigerUsers2group) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerUsers2group", id);
			if (instance == null) {
	...
	public List findByExample(VtigerUsers2group instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerUsers2group")
