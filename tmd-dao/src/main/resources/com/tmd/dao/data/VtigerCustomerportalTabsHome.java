 ...
 * @see com.tmd.dao.data.VtigerCustomerportalTabs
 * @author Hibernate Tools
 */
public class VtigerCustomerportalTabsHome {

	private static final Log log = LogFactory.getLog(VtigerCustomerportalTabsHome.class);
	...
	public VtigerCustomerportalTabs merge(VtigerCustomerportalTabs detachedInstance) {
		log.debug("merging VtigerCustomerportalTabs instance");
		try {
			VtigerCustomerportalTabs result = (VtigerCustomerportalTabs) sessionFactory.getCurrentSession()
	...
	public VtigerCustomerportalTabs findById(int id) {
		...
		try {
			VtigerCustomerportalTabs instance = (VtigerCustomerportalTabs) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerCustomerportalTabs", id);
			if (instance == null) {
	...
	public List findByExample(VtigerCustomerportalTabs instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerCustomerportalTabs").add(Example.create(instance)).list();
