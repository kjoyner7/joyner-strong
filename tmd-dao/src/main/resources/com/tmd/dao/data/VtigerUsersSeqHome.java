 ...
 * @see com.tmd.dao.data.VtigerUsersSeq
...
public class VtigerUsersSeqHome {
	...
	public VtigerUsersSeq merge(VtigerUsersSeq detachedInstance) {
		...
		try {
			VtigerUsersSeq result = (VtigerUsersSeq) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public VtigerUsersSeq findById(int id) {
		...
		try {
			VtigerUsersSeq instance = (VtigerUsersSeq) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerUsersSeq", id);
			if (instance == null) {
	...
	public List findByExample(VtigerUsersSeq instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerUsersSeq")
