 ...
 * @see com.tmd.dao.data.VtigerInvoicebillads
 * @author Hibernate Tools
 */
public class VtigerInvoicebilladsHome {

	private static final Log log = LogFactory.getLog(VtigerInvoicebilladsHome.class);
	...
	public VtigerInvoicebillads merge(VtigerInvoicebillads detachedInstance) {
		...
		try {
			VtigerInvoicebillads result = (VtigerInvoicebillads) sessionFactory.getCurrentSession()
	...
	public VtigerInvoicebillads findById(int id) {
		...
		try {
			VtigerInvoicebillads instance = (VtigerInvoicebillads) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInvoicebillads", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInvoicebillads instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerInvoicebillads")
