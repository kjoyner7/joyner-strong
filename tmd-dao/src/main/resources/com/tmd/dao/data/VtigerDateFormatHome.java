 ...
 * @see com.tmd.dao.data.VtigerDateFormat
 * @author Hibernate Tools
 */
public class VtigerDateFormatHome {

	private static final Log log = LogFactory.getLog(VtigerDateFormatHome.class);
	...
	public VtigerDateFormat merge(VtigerDateFormat detachedInstance) {
		...
		try {
			VtigerDateFormat result = (VtigerDateFormat) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public VtigerDateFormat findById(java.lang.Integer id) {
		log.debug("getting VtigerDateFormat instance with id: " + id);
		try {
			VtigerDateFormat instance = (VtigerDateFormat) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerDateFormat", id);
			if (instance == null) {
	...
	public List findByExample(VtigerDateFormat instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmd.dao.data.VtigerDateFormat")
