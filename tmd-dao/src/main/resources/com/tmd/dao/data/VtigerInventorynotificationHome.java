 ...
 * @see com.tmd.dao.data.VtigerInventorynotification
 * @author Hibernate Tools
 */
public class VtigerInventorynotificationHome {

	private static final Log log = LogFactory.getLog(VtigerInventorynotificationHome.class);
	...
	public VtigerInventorynotification merge(VtigerInventorynotification detachedInstance) {
		log.debug("merging VtigerInventorynotification instance");
		try {
			VtigerInventorynotification result = (VtigerInventorynotification) sessionFactory.getCurrentSession()
	...
	public VtigerInventorynotification findById(java.lang.Integer id) {
		log.debug("getting VtigerInventorynotification instance with id: " + id);
		try {
			VtigerInventorynotification instance = (VtigerInventorynotification) sessionFactory.getCurrentSession()
					.get("com.tmd.dao.data.VtigerInventorynotification", id);
			if (instance == null) {
	...
	public List findByExample(VtigerInventorynotification instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.tmd.dao.data.VtigerInventorynotification").add(Example.create(instance))
					.list();
